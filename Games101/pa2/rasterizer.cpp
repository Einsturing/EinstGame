...
{   
    ...
    Eigen::Vector2f P, A, B, C, AB, BC, CA, AP, BP, CP;
    P << x, y;
    A = _v[0].head(2);
    B = _v[1].head(2);
    C = _v[2].head(2);
    ...
    BP = P - B;
    CP = P - C;
    return ((AP[0] * AB[1] - AP[1] * AB[0] > 0 && BP[0] * BC[1] - BP[1] * BC[0] > 0 && CP[0] * CA[1] - CP[1] * CA[0] > 0)||
    (AP[0] * AB[1] - AP[1] * AB[0] < 0 && BP[0] * BC[1] - BP[1] * BC[0] < 0 && CP[0] * CA[1] - CP[1] * CA[0] < 0));
}
...
void rst::rasterizer::rasterize_triangle(const Triangle& t)
{
    ...
    double minx = std::min(v[0][0], std::min(v[1][0], v[2][0]));
    double maxx = std::max(v[0][0], std::max(v[1][0], v[2][0]));
    double miny = std::min(v[0][1], std::min(v[1][1], v[2][1]));
    double maxy = std::max(v[0][1], std::max(v[1][1], v[2][1]));
